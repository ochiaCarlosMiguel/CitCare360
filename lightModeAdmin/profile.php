    ...
    <style>
        ...
        * {
        ...
        .profile-image-container img {
            ...
            box-shadow: 0 4px 8px rgba(230, 184, 175, 0.2);
        }
        ...
        .edit-profile-container {
            ...
            border-top: 1px solid rgba(230, 184, 175, 0.2);
        }
        ...
        .edit-profile-btn:hover {
            ...
            color: #FFFFFF;
            transform: translateY(-2px);
            box-shadow: 0 4px 8px rgba(230, 184, 175, 0.3);
        }
    </style>
            ...
            <div class="main-content">
                <div class="profile-card">
                    <div class="profile-image-container">
                        <img src="<?php echo htmlspecialchars('../image/' . $user['profile_image']); ?>" alt="Profile Picture">
