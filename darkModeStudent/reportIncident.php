...
<head>
  ...
  <style>
    * { 
    ...
    .card {
      background-color: rgba(30, 30, 30, 0.7); /* Updated background color to match reportStatus.php */
    ...
    <div class="card">
      ...
      <form class="report-form" id="incidentForm" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="schedule-section" style="margin-top: 20px;">
            <h3 style="color: #f4a261; margin-bottom: 15px;">Schedule Meeting (Optional)</h3>
...
This report is submitted by [${document.getElementById('fullName').value}] on [${currentDate}].`;
    ...
    function loadAvailableTimes() {
        ...
        timeSlots.forEach(time => {
            ...
            option.style.color = isBlocked ? '#e76f51' : '#fff';
