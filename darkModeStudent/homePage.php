...
<head>
  ...
  <style>
    * { 
    ...
    .services {
      background: linear-gradient(135deg, #4F46E5, #6B5BCE, #FF6F61, #4F46E5);
    ...
    .service-box {
      background: #222232;
      color: #fff;
      width: 800px; /* Increased width for single service */
    ...
    .service-box h3 {
      font-size: 24px; /* Increased service title font size */
