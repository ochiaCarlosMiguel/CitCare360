    ...
    <style>
        ...
        * {
        ...
        #modalImage {
            ...
            max-width: 100%; /* Ensure it takes full width of the modal */
            height: auto; /* Maintain aspect ratio */
            transition: transform 0.3s ease; /* Smooth scaling effect */
        }

        #modalImage:hover {
            transform: scale(1.1); /* Slightly enlarge image on hover for a more pronounced effect */
        }

        /* Style for the close button */
        .close {
            color: #F8B83C; /* Change color to match the theme */
        ...
        .close:hover {
            color: #10375A; /* Change color on hover for better visibility */
        }

        /* Add this CSS to your existing styles */
        #imagesContainer {
            display: flex;
            flex-direction: row; /* Change to row to display images horizontally */
            flex-wrap: wrap; /* Allow images to wrap to the next line if necessary */
            justify-content: center; /* Center images horizontally */
        }

        #imagesContainer img {
            max-width: 30%; /* Set a max width for each image */
            height: auto; /* Maintain aspect ratio */
        ...
        #imagesContainer button:hover {
            background-color: #F8B83C; /* Change background color on hover */
        }
