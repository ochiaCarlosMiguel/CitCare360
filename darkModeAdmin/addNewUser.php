    ...
    <style>
        ...
        * {
        ...
        .add-user-btn {
            width: 100%;
            padding: 12px;
            background: #FF5733; /* Changed to a vibrant color */
        ...
        .add-user-btn:hover {
            background: #C70039; /* Darker shade on hover */
        ...
        .message.error {
            background: rgba(255, 0, 0, 0.3); /* More visible error background */
            color: #FF0000; /* Bright red for error */
        }

        .message.success {
            background: rgba(0, 255, 0, 0.3); /* More visible success background */
            color: #008000; /* Dark green for success */
        }
