...
<body>
            ...
            <ul class="nav-links">
                ...
                <li class="dropdown open">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="active"><a href="uploadStudents.php"><i class="fas fa-upload"></i>Upload Students</a></li>
        ...
        <!-- Main Content -->
        <div class="main-content" style="margin-left: 249px; padding: 80px 20px 20px; font-family: 'Century Gothic', sans-serif;">
            <div class="content-wrapper" style="background: rgba(50, 50, 50, 0.9); backdrop-filter: blur(15px); border-radius: 15px; padding: 40px; max-width: 600px; margin: 0 auto;">
                <!-- Header -->
                <div class="content-header" style="margin-bottom: 30px;">
                    <div class="header-top" style="display: flex; align-items: center; margin-bottom: 15px; position: relative;">
                        <a href="existingStudents.php" class="back-btn" style="display: flex; align-items: center; gap: 5px; color: #AEB2B7; text-decoration: none; font-family: 'Century Gothic', sans-serif; padding: 8px 15px; background: rgba(64, 62, 62, 0.9); border-radius: 5px; transition: all 0.3s ease; position: absolute; left: 0;">
                            <i class="fas fa-arrow-left"></i> Back
                        </a>
                        <h2 style="color: #F8B83C; font-family: 'Century Gothic', sans-serif; display: flex; align-items: center; gap: 10px; padding-bottom: 15px; margin: 0 auto;">
                            <i class="fas fa-user-graduate"></i> Add Existing Student
                        </h2>
                    </div>
                ...
                <!-- Form Container -->
                <div class="form-container" style="max-width: 500px; margin: 30px auto 0;">
                    <form id="studentForm" action="processStudentUpload.php" method="POST">
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                            <!-- Student Number -->
                            <div class="form-group" style="position: relative; margin-bottom: 20px;">
                                <i class="fas fa-id-card" style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #AEB2B7;"></i>
                                <input type="text" id="studentNo" name="studentNo" placeholder="Student No." required 
                                    style="width: 100%; padding: 12px 40px; padding-right: 45px; background: rgba(64, 62, 62, 0.9); border: 1px solid #555; border-radius: 5px; color: #AEB2B7; font-family: 'Century Gothic', sans-serif;">
                            </div>

                            <!-- Year Level -->
                            <div class="form-group" style="position: relative; margin-bottom: 20px;">
                                <i class="fas fa-graduation-cap" style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #AEB2B7;"></i>
                                <select id="yearLevel" name="yearLevel" required 
                                    style="width: 100%; padding: 12px 40px; padding-right: 45px; background: rgba(64, 62, 62, 0.9); border: 1px solid #555; border-radius: 5px; color: #AEB2B7; font-family: 'Century Gothic', sans-serif; appearance: none; -webkit-appearance: none; -moz-appearance: none;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                            <!-- First Name -->
                            <div class="form-group" style="position: relative; margin-bottom: 20px;">
                                <i class="fas fa-user" style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #AEB2B7;"></i>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                            ...
                            <!-- Email Address -->
                            <div class="form-group" style="position: relative; margin-bottom: 20px;">
                                <i class="fas fa-envelope" style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #AEB2B7;"></i>
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            <button type="submit" 
                                style="width: 100%; padding: 12px; background: #FF5733; color: #FFFFFF; border: none; border-radius: 5px; font-family: 'Century Gothic', sans-serif; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 10px; transition: background-color 0.3s, transform 0.2s;">
                    ...
                    <!-- Messages -->
                    <div class="message error" style="padding: 15px; border-radius: 8px; margin-top: 20px; display: none; align-items: center; gap: 10px; font-family: 'Century Gothic', sans-serif; font-weight: bold; background: rgba(255, 0, 0, 0.3); color: #FF0000;" id="errorMessage">
                        <i class="fas fa-exclamation-circle"></i>
                        <span id="errorText">Please fill in all required fields</span>
                    </div>
                    <div class="message success" style="padding: 15px; border-radius: 8px; margin-top: 20px; display: none; align-items: center; gap: 10px; font-family: 'Century Gothic', sans-serif; font-weight: bold; background: rgba(0, 255, 0, 0.3); color: #008000;" id="successMessage">
                        <i class="fas fa-check-circle"></i>
                        <span id="successText">Student added successfully!</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                studentForm.addEventListener('submit', function(e) {
                    ...
                    // Send form data
                    fetch('processStudentUpload.php', {
                        method: 'POST',
                        body: formData
                    })
